...
public class ModPlacedFeatures {
    ...
    public static final RegistryObject<PlacedFeature> ZIRCON_ORE_PLACED = PLACED_FEATURES.register("zircon_ore_placed",
            () -> new PlacedFeature(ModConfiguredFeatures.ZIRCON_ORE.getHolder().get(), commonOrePlacement(7,
    ...
    public static List<PlacementModifier> commonOrePlacement(int veinPerChunk, PlacementModifier p_195345_) {
        return orePlacement(CountPlacement.of(veinPerChunk), p_195345_);
    }
